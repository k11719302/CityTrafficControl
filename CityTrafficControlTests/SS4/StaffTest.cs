...
namespace CityTrafficControlTests.SS4
{
	...
	public class StaffTest
	{
		...
		public void Test_Init()
		{
			...
			workers1.Add(p1.GetPersonID(), p1);
			workers1.Add(p2.GetPersonID(), p2);
			workers1.Add(3, new Person(3, "John", "spec3"));

			team1 = new Team(workers1, 1);

			workers2.Add(1, new Person(1, "Peter", "spec1"));
			workers2.Add(2, new Person(2, "Markus", "spec2"));
			workers2.Add(3, new Person(3, "Klaus", "spec3"));

			team2 = new Team(workers2, 2);

			Person p3 = new Person(1, "Hubert", "spec1");
			p3.SetOperational(false);
			Person p4 = new Person(3, "Ludwig", "spec3");
			p4.SetOperational(false);

			workers3.Add(p3.GetPersonID(), p3);
			workers3.Add(2, new Person(2, "Robert", "spec2"));
			workers3.Add(p4.GetPersonID(), p4);
		...
		public void Test_IsReady_Team()
        {
			...
			Assert.AreEqual(false, staff.IsReady(team1));
			Assert.AreEqual(true, staff.IsReady(team2));
			Assert.AreEqual(false, staff.IsReady(team3));
        }
	}
}
